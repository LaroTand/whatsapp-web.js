...
class Client extends EventEmitter {
    ...
    async initialize() {
        ...
        const INTRO_IMG_SELECTOR =
            '[data-testid="intro-md-beta-logo-dark"], [data-testid="intro-md-beta-logo-light"], [data-asset-intro-image-light="true"], [data-asset-intro-image-dark="true"], [data-icon="intro-md-beta-logo-dark"], [data-icon="intro-md-beta-logo-light"]';
    ...
    async sendMessage(chatId, content, options = {}) {
        const messagePromise = () =>
            new Promise(async (resolve, reject) => {
                let internalOptions = {
                    linkPreview:
                        options.linkPreview === false ? undefined : true,
                ...
                const sendSeen =
                    typeof options.sendSeen === "undefined"
                        ? true
                        : options.sendSeen;
        ...
        messageQueue = messageQueue
            .then(() => delay(randomIntFromInterval(10000, 40000))) // Wait between 10-30 seconds to simulate real user
            ...
            .then(() =>
                this.getChatById(chatId)
                    ...
                    .then(() => delay(randomIntFromInterval(5000, 10000)))
                    .catch((err) => {
                        console.log(err);
                    })
            )
